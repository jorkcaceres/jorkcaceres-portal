...
import { createDiagnostic } from './diagnostic/ui.js?v=1.2.3';
...
const privateRoutes = new Set(['inicio', 'proyectos', 'servicios', 'encuestas', 'admin', 'admin-clientes', 'admin-proyectos', 'admin-servicios', 'admin-pagos', 'admin-encuestas', 'admin-portal', 'diagnosticos', 'admin-diagnosticos', 'admin-sugerencias']);
